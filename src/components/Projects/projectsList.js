...
export const projects=[
    ...
    },
    {
        ...
        desc:'Based on user input the chart gets sliced to a provided number of parts of randomly generated width. For numbers lower than 12 the colours are based on a basic colour wheel and in accordance with the graphic design principles. If there are more than 12 slices their colours get generated randomly. User can also choose a different animation mood.',
